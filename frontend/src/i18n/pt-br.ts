...
export const caseDetail = {
  ...
  labels: {
    ...
    created: 'Criado em',
    // Reporter & intake
    reporterType: 'Tipo de Relator',
    reporterCountry: 'País do Relator',
    receivedChannel: 'Canal de Recebimento',
    receivedDate: 'Data de Recebimento',
    // Product traceability
    manufacturingSite: 'Planta de Fabricação',
    expiryDate: 'Data de Validade',
    sampleAvailable: 'Amostra Disponível',
    // Compliance & regulatory
    adverseEventFlag: 'Evento Adverso',
    regulatoryReportable: 'Notificável (Regulatório)',
    regulatoryClassification: 'Classificação Regulatória',
    // Investigation
    investigationStatus: 'Status da Investigação',
    rootCause: 'Causa Raiz',
    capaReference: 'Referência CAPA',
    assignedInvestigator: 'Investigador Designado',
    slaDueDate: 'Prazo SLA',
    // AI
    aiRecommendation: 'Recomendação IA',
    aiConfidence: 'Confiança IA',
    guardianApproved: 'Aprovado pelo Guardian',
    processedByAgent: 'Processado por Agente',
  },
  // Section titles
  sections: {
    productComplaint: 'Produto & Reclamação',
    reporterChannel: 'Relator & Canal',
    complianceRegulatory: 'Conformidade & Regulatório',
  ...
  regulatoryClassifications: {
    NONE: 'Nenhuma',
    MDR: 'MDR (Relatório Dispositivo Médico)',
    MIR: 'MIR (Relatório Informação Médica)',
    FIELD_ALERT: 'Alerta de Campo',
    SERIOUS_AE: 'Evento Adverso Sério',
  },
  ...
  booleanYes: 'Sim',
  booleanNo: 'Não',
  awaitingProcessing: 'Aguardando processamento pelo mesh de agentes',
